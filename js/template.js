(function($){
	$(document).ready(function(){
		...
		$(window).load(function() {
			$(".embed-responsive, .embed-responsive-16by9").append('<iframe width="560" height="315" src="https://www.youtube.com/embed/cNm-M8uIxJI?rel=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>');
		});
